...
intervalo
```
Então o valor real da proporção deveria estar entre 0.23 e 0.25.
...
Então, pela lib boot o IC também foi entre 0.23 e 0.25.
...
# Primeiro vamos filtrar os usuários que gostam de música muito pop.
```{r}
